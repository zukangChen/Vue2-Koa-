<template>
  <div>
    ...
    <div>
      <van-tabs swipeable sticky title-active-color="red">
        <van-tab title="商品详情">
    ...
    <div class="goods-bottom">
      <div>
        <van-button @click="addGoodsToCart" round size="large" type="primary">加入购物车</van-button>
      </div>
      <div>
        <van-button round size="large" type="danger">直接购买</van-button>
      </div>
    </div>
  </div>
</template>
